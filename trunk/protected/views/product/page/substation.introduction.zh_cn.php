	...
	<tr>
		<td>
			<div class="product-info-box">
				...
				<p>
					<strong>测量精准，不错失每一个细节：</strong>可实现高清晰度视频图像传输，实现远程浏览视频图像信息，集中管理，集中图像存储，具有远程控制、报警联动功能。
				</p>
		...
		<td>
			<div class="product-info-box">
				...
				<a
					href="<?php echo Yii::app()->request->baseUrl; ?>/images/zh_cn/products/substation/04b.jpg"
					title="" rel="prettyPhoto"
					class="img-border preloading-light align-right project-thumbnail image-preview">
					<img
					src="<?php echo Yii::app()->request->baseUrl; ?>/images/zh_cn/products/substation/04a.jpg"
					alt="">
				</a>
	...
	<tr>
		<td>
			<div class="product-info-box">
				...
				<a
					href="<?php echo Yii::app()->request->baseUrl; ?>/images/zh_cn/products/substation/05b.jpg"
					title="" rel="prettyPhoto"
					class="img-border preloading-light align-right project-thumbnail image-preview">
					<img
					src="<?php echo Yii::app()->request->baseUrl; ?>/images/zh_cn/products/substation/05a.jpg"
					alt="">
				</a>
		...
		<td>
			<div class="product-info-box">
				...
				<a
					href="<?php echo Yii::app()->request->baseUrl; ?>/images/zh_cn/products/substation/06b.jpg"
					title="" rel="prettyPhoto"
					class="img-border preloading-light align-right project-thumbnail image-preview">
					<img
					src="<?php echo Yii::app()->request->baseUrl; ?>/images/zh_cn/products/substation/06a.jpg"
					alt="">
				</a>
