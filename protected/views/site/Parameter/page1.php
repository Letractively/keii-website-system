...
$this->pageTitle=Yii::app()->name . ' - 技术参数';
...
<li class="current"><a href="Parameter_1.html" title="">技术参数</a>
</li>
</ul>
...
<object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="650" height="500">
  <param name="movie" value="swf/06.swf">
...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/parameter&page=1" title="" class="current">1</a>
<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/parameter&page=2" title="" >2</a>
<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/parameter&page=3" title="" >3</a>
</div>
<!--/Pagination-->
</div>
