...
<object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="650" height="500">
  <param name="movie" value="swf/08.swf">
...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/parameter&page=1" title="" >1</a>
<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/parameter&page=2" title="" >2</a>
<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/parameter&page=3" title="" class="current">3</a>
</div>
<!--/Pagination-->
