<div  id="navigation-bar">
		...
		$itemOptions = array('home' => array('class' =>'l1' ),
			...
			'items'=>array(
				...
				'items'=>array(
						array('label'=>Yii::t('zii', 'menu.index.application_gallery.industries').'»', 'url'=>array('/application/industry'),'itemOptions'=>array('class'=>'l2'),
								'items'=>array(
						...
						array('label'=>Yii::t('zii', 'menu.index.application_gallery.applications').'»', 'url'=>array('/application/case'),'itemOptions'=>array('class'=>'l2'),
							'items'=>array(
				...
				array('label'=>Yii::t('zii', 'menu.index.service&support.abbr'), 'url'=>array('/service/index'),'itemOptions'=>$itemOptions['service'],
					'items'=>array(
