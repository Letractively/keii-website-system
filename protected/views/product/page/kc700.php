	...
	<div class="fixed-width-wrapper">
		...
		<div id="content" class="fixed-width-wrapper">
			...
			<div class="two-third first">
				<?php echo CHtml::image(Yii::app()->request->baseUrl.'/images/'.Yii::app()->language.'/products/kc700/index.jpg',('KC700'),array('class'=>'align-left'));?>
			</div>
			...
			<div class="three-fourth first">
				...
				<div id="product_tabs">
					...
					<div id="tabs-1">
					<?php $this->renderPartial('//product/page/kc700.introduction.'.Yii::app()->language); ?>
					</div>
					<div id="tabs-2">
					<?php $this->renderPartial('//product/page/kc700.parameter.'.Yii::app()->language); ?>						
					</div>
